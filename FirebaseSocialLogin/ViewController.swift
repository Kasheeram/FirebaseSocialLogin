...
class ViewController: UIViewController, FBSDKLoginButtonDelegate, GIDSignInUIDelegate {
    ...
    func loginButton(_ loginButton: FBSDKLoginButton!, didCompleteWith result: FBSDKLoginManagerLoginResult!, error: Error!) {
        ...
        if let userToken = result.token{
            ...
            let presentPage = self.storyboard?.instantiateViewController(withIdentifier: "PresentViewController") as! PresentViewController
...
//            let vcOBJ = storyBoard.instantiateViewController(withIdentifier: "PresentViewController") as! PresentViewController
